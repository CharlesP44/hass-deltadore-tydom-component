...
class GenericSensor(SensorEntity):
    ...
    def __init__(
        ...
        if device_class == SensorDeviceClass.BATTERY and unit_of_measurement is None:
...
class HaWindow(CoverEntity, HAEntity):
    ...
    def is_closed(self) -> bool | None:
        ...
        if hasattr(self._device, "openState"):
            ...
            intrusion_detect = getattr(self._device, "intrusionDetect", None)
            if intrusion_detect is None:
                return None
